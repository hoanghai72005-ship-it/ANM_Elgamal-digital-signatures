...
- Bước 2: Tải thư mục chứa mã nguồn này về máy. Đảm bảo trong thư mục 
  ...
  2. elgamal_gui.py   (Giao diện phần mềm) 
    - Cài đặt thư viện đồ họa: pip install PySide6
    - Cài đặt thư viện đọc file: pip install PySide6 python-docx pypdf openpyxl
...
📍 BƯỚC B: MÃ HÓA & GIẢI MÃ CHUỖI KÝ TỰ (Tab 1)
